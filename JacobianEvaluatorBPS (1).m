function df_dx = JacobianEvaluatorBPS(desiredX)
...
Tx = ((Ib+Ip+m*x*x)*alphadotdot)+(2*m*alphadot*x*xdot)+(m*x*y*betadotdot)+(m*xdot*y*betadot)+(m*x*ydot*betadot)+(m*g*x*cos(alpha));
Ty = ((Ib+Ip+m*y*y)*betadotdot)+(2*m*betadot*y*ydot)+(m*x*y*alphadotdot)+(m*ydot*x*alphadot)+(m*y*xdot*alphadot)+(m*g*y*cos(beta));
