...
desiredx(simspan<=timelimit)=((balancepos(1)-init1(1))/timelimit).*simspan(simspan<=timelimit)+init1(1);
desiredx(simspan>timelimit)=balancepos(1);
desiredvx=gradient(desiredx)/tstep;
desiredy=zeros(1,size(simspan,2));
desiredy(simspan<=timelimit)=((balancepos(2)-init1(3))/timelimit).*simspan(simspan<=timelimit)+init1(3);
